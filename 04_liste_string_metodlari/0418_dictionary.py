...
print(programlamaDilleri["dil"])
print(programlamaDilleri.keys())
print(programlamaDilleri.values())
print(programlamaDilleri.items())


del programlamaDilleri["interpreter"]
...
print(sirket["sirketArabalari"][1])
"""
...
icecekler = jsonDatas["drinks"]
print(type(icecekler))
for i in icecekler:
    print(f"{i['idDrink']} - {i['strDrink']}")
...
def oKArti(ad, soyad, dTarihi):
    print(f"selam öğrencimiz → {ad} {soyad} {2021-dTarihi}")


a=int(input("DTarihi Giriniz : ")) #fonksiyon cagirirken tip donusumu yapilmaz.
oKArti(dTarihi=a, ad=input("Ad Giriniz : "), soyad=input("SoyAd Giriniz : "))
